...
dotenv.config();
// TODO: generate logos for the new cafes
const cafes = [
  {
...
const seedDatabase = async () => {
  try {
    ...
    // const imagesPath = path.join(__dirname, '../assets/img');
    ...
    // const cafes = imageFiles.map((file) => {
    //   return {
    //     name: `Cafe ${file}`,
    ...
    //     file.startsWith(cafe.name.replace(' ', '_').toLowerCase())
    //   );
    //   if (logoFile) {
    //     const filePath = path.join(imagesPath, logoFile);
...
// TODO: Upload cafe logos to seedDatabase
// const seedDatabase = async () => {
//   try {
//     await connectDB();
//     // Clear existing data
